    ...
    body = (
      <div className={classes.paper}>
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>{[ 'Bitcoin', 'PlayStation 5', 'Smartphones','News'].map((term) => <Chip label={term} color="primary" className={classes.chip} />)}<Chip label="...and more" className={classes.chip} /></div>
        </div>
